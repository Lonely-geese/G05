...
try:
    # The pinned FA4 release only supports backward on SM90 and newer.
    # Ampere (including A800) must use FA2 or the SDPA fallback for training.
    if not torch.cuda.is_available() or torch.cuda.get_device_capability()[0] < 9:
        raise ImportError("FA4 backward requires SM90 or newer")
