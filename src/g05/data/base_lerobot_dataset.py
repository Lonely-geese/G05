...
class BaseLerobotDataset(torch.utils.data.Dataset):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        for ds_dir in dataset_dirs:
            ...
            if meta.info.get("requires_correction_window_index") and not getattr(self, "supports_correction_windows", False):
                raise ValueError("This dataset requires CorrectionWindowDataset; unrestricted frame sampling is unsafe.")
            metas.append(meta)
        try:
    ...
    def _resolve_sample_index(self, idx: int) -> int:
        """Map a logical item to a raw frame; filtered datasets can override this."""
