...
class BaseLerobotDatasetV3(BaseLerobotDataset):
    ...
    def _fast_get_dataset_stats(
        ...
        # Dataset adapters may impose stricter temporal boundaries (e.g. cuts).
        if hasattr(self, "stats_sequence_boundaries"):
            ep_starts, ep_ends, N_from_meta = self.stats_sequence_boundaries()
