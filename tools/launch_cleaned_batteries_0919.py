...
ARTIFACTS = Path('/mnt/cfs/7rnh3z/kele/0919/mt/cleaned_batteries/training/g05')
GBS = int(os.environ.get('GBS', '128'))
assert GBS == 128
STEPS = 920
NAME = os.environ.get('EXP_NAME', f'right_arm_base_gbs{GBS}_ep10_20260921')
OUTPUT = ROOT / 'outputs/cleaned_batteries_0919' / NAME
...
if __name__ == '__main__':
    ...
    with (ARTIFACTS / 'train.log').open('x') as log:
        process = subprocess.Popen(['bash', str(ROOT / 'run_cleaned_batteries_0919.sh'), 'train'],
